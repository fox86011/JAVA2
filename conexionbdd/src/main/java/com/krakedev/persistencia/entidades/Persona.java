...
public class Persona {
	...
	public Persona(String cedula, String nombre, String apellido, int numeroHijos, double estatura,
			BigDecimal cantidadAhorrada, Date fechaNacimiento, Date horaNacimiento) {
		super();
		this.cedula = cedula;
		this.nombre = nombre;
	...
	public String toString() {
		return "Persona [cedula=" + cedula + ", nombre=" + nombre + ", apellido=" + apellido + ", numeroHijos="
				+ numeroHijos + ", estatura=" + estatura + ", cantidadAhorrada=" + cantidadAhorrada
